  ...
  <div class="container">
    ...
    <div class="services-grid">
      <a href="{{ $isRu ? '/ru/services/prigon-tesla-usa/' : '/services/prigon-tesla-usa/' }}" class="service-card">
        ...
        <div class="service-title">{{ $isRu ? 'ПРИГОН ИЗ США' : 'ДОСТАВКА ЗІ США' }}</div>
        <div class="service-text">
          {{ $isRu
            ? 'NikolaCars поможет подобрать и привезти Tesla из США под ключ: покупка, доставка, растаможка и подготовка.'
            : 'Компанія NikolaCars стане вашим надійним помічником у виборі та купівлі автомобіля Tesla із США під ключ.'
          }}
        </div>
      ...
      <a href="{{ $isRu ? '/ru/services/tesla-service/' : '/services/tesla-service/' }}" class="service-card">
        ...
        <div class="service-title">{{ $isRu ? 'СЕРВИС TESLA' : 'ОБСЛУГОВУВАННЯ АВТО' }}</div>
        <div class="service-text">
          {{ $isRu
            ? 'Профессиональное обслуживание Tesla: диагностика, ТО, ремонт, подбор запчастей и сопровождение.'
            : 'Для підтримки хорошого стану електромобілі вимагають меншого обсягу робіт.'
          }}
        </div>
        <div class="service-more">{{ $isRu ? 'Читать далее' : 'Читати далі' }}</div>
      </a>
      ...
      <a href="{{ $isRu ? '/ru/services/firmware-auto/' : '/services/firmware-auto/' }}" class="service-card">
        ...
        <div class="service-text">
          {{ $isRu
            ? 'Обновление ПО, активация функций и корректная настройка систем автомобиля.'
            : 'Спеціалісти нашої компанії нададуть послуги оновлення прошивки автомобіля Tesla до актуальної версії.'
          }}
        </div>
        <div class="service-more">{{ $isRu ? 'Читать далее' : 'Читати далі' }}</div>
      </a>
      ...
      <a href="{{ $isRu ? '/ru/services/vidnovlennya-sertyfikativ-tesla/' : '/services/vidnovlennya-sertyfikativ-tesla/' }}" class="service-card">
        ...
        <div class="service-text">
          {{ $isRu
            ? 'Возврат Tesla App, обновлений и функций автомобиля через корректные решения.'
            : 'Компанія надає повний спектр послуг з відновлення сертифікатів через офіційного дилера.'
          }}
        </div>
        <div class="service-more">{{ $isRu ? 'Читать далее' : 'Читати далі' }}</div>
      </a>
