  ...
  <div class="container">
    <div class="service-article-card">
      ...
      <div class="service-article-text">
        ...
        <p>
          {!! $isRu
            ? 'Также можем помочь с <a href="/ru/services/vidnovlennya-sertyfikativ-tesla/">восстановлением сертификатов Tesla</a> для корректной работы сервисов и OTA-обновлений.'
            : 'Також можемо допомогти з <a href="/services/vidnovlennya-sertyfikativ-tesla/">відновленням сертифікатів Tesla</a> для коректної роботи сервісів і OTA-оновлень.'
          !!}
        </p>
